...
@objc public protocol MediaBrowserViewDelegate: NSObjectProtocol {
    ...
    @objc optional func mediaBrowserView(_ browserView: MediaBrowserView, willScrollHalf fromIndexPath: IndexPath, toIndexPath: IndexPath)
    @objc optional func mediaBrowserView(_ browserView: MediaBrowserView, didScrollTo indexPath: IndexPath)
